...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filament-easy-footer.app_name' => 'string',
            'filament-easy-footer.github.repository' => 'string',
            'filament-easy-footer.github.token' => 'string',
            'filament-easy-footer.github.cache_ttl' => 'integer',
            'filament-money-field.default_locale' => 'string',
            'filament-money-field.default_currency' => 'string',
            'filament-money-field.use_input_mask' => 'boolean',
            'filament-money-field.decimal_digits' => 'integer',
            'filament-money-field.intl_currency_symbol' => 'boolean',
            'filament-money-field.form_currency_symbol_placement' => 'string',
            ...
            'filesystems.links./Users/milon/Code/takakori/public/storage' => 'string',
...
'database.redis.cache.username','database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','filament-easy-footer.app_name',
'filament-easy-footer.github.repository','filament-easy-footer.github.token','filament-easy-footer.github.cache_ttl','filament-money-field.default_locale','filament-money-field.default_currency',
'filament-money-field.use_input_mask','filament-money-field.decimal_digits','filament-money-field.intl_currency_symbol','filament-money-field.form_currency_symbol_placement','filesystems.default',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./Users/milon/Code/takakori/public/storage','logging.default',
...
'livewire.navigate.show_progress_bar','livewire.navigate.progress_bar_color','livewire.inject_morph_markers','livewire.pagination_theme','blade-fontawesome.brands.prefix',
...
'blade-fontawesome.custom.class','blade-fontawesome.custom.attributes','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'ide-helper.macroable_traits','blueprint.namespace','blueprint.models_namespace','blueprint.controllers_namespace','blueprint.components_namespace',
...
'filament.exports.download','filament.imports.failed-rows.download','filament.app.auth.login','filament.app.auth.password-reset.request','filament.app.auth.password-reset.reset',
'filament.app.auth.register','filament.app.auth.logout','filament.app.auth.email-verification.prompt','filament.app.auth.email-verification.verify','filament.app.home',
'filament.app.pages.dashboard','filament.app.pages.my-profile','filament.app.resources.accounts.index','filament.app.resources.accounts.view','filament.app.resources.bill-reminders.index',
'filament.app.resources.budgets.index','filament.app.resources.categories.index','filament.app.resources.currencies.index','filament.app.resources.debts.index','filament.app.resources.goals.index',
'filament.app.resources.investments.index','filament.app.resources.investments.view','filament.app.resources.recurring-transactions.index','filament.app.resources.tags.index','filament.app.resources.transactions.index',
'filament.app.resources.users.index','filament.app.resources.users.view','filament.app.auth.two-factor','livewire.update','livewire.upload-file','livewire.preview-file','storage.local',);
...
'filament-breezy::livewire.sanctum-tokens','filament-breezy::livewire.two-factor-authentication','filament-breezy::livewire.update-password','filament.logo.dark','filament.logo.light',
'filament.pages.auth.register','filament.pages.dashboard','vendor.filament-breezy.components.clipboard-link','vendor.filament-breezy.components.grid-section','vendor.filament-breezy.filament.pages.my-profile',
'vendor.filament-breezy.filament.pages.two-factor','vendor.filament-breezy.livewire.personal-info','vendor.filament-breezy.livewire.sanctum-tokens','vendor.filament-breezy.livewire.two-factor-authentication','vendor.filament-breezy.livewire.update-password',
...
'filament-breezy::components.clipboard-link','filament-breezy::components.grid-section','filament-breezy::filament.pages.my-profile','filament-breezy::filament.pages.two-factor','filament-breezy::livewire.personal-info',
'filament-breezy::livewire.sanctum-tokens','filament-breezy::livewire.two-factor-authentication','filament-breezy::livewire.update-password','filament-easy-footer::easy-footer','filament-easy-footer::github-version',
...
'filament-tables::table.sorting.fields.direction.options.desc','filament-breezy::default.password_confirm.heading','filament-breezy::default.password_confirm.description','filament-breezy::default.password_confirm.current_password','filament-breezy::default.two_factor.heading',
'filament-breezy::default.two_factor.description','filament-breezy::default.two_factor.code_placeholder','filament-breezy::default.two_factor.recovery.heading','filament-breezy::default.two_factor.recovery.description','filament-breezy::default.two_factor.recovery_code_placeholder',
'filament-breezy::default.two_factor.recovery_code_text','filament-breezy::default.two_factor.recovery_code_link','filament-breezy::default.two_factor.back_to_login_link','filament-breezy::default.profile.account','filament-breezy::default.profile.profile',
'filament-breezy::default.profile.my_profile','filament-breezy::default.profile.subheading','filament-breezy::default.profile.personal_info.heading','filament-breezy::default.profile.personal_info.subheading','filament-breezy::default.profile.personal_info.submit.label',
'filament-breezy::default.profile.personal_info.notify','filament-breezy::default.profile.password.heading','filament-breezy::default.profile.password.subheading','filament-breezy::default.profile.password.submit.label','filament-breezy::default.profile.password.notify',
'filament-breezy::default.profile.2fa.title','filament-breezy::default.profile.2fa.description','filament-breezy::default.profile.2fa.actions.enable','filament-breezy::default.profile.2fa.actions.regenerate_codes','filament-breezy::default.profile.2fa.actions.disable',
'filament-breezy::default.profile.2fa.actions.confirm_finish','filament-breezy::default.profile.2fa.actions.cancel_setup','filament-breezy::default.profile.2fa.setup_key','filament-breezy::default.profile.2fa.must_enable','filament-breezy::default.profile.2fa.not_enabled.title',
'filament-breezy::default.profile.2fa.not_enabled.description','filament-breezy::default.profile.2fa.finish_enabling.title','filament-breezy::default.profile.2fa.finish_enabling.description','filament-breezy::default.profile.2fa.enabled.notify','filament-breezy::default.profile.2fa.enabled.title',
'filament-breezy::default.profile.2fa.enabled.description','filament-breezy::default.profile.2fa.enabled.store_codes','filament-breezy::default.profile.2fa.disabling.notify','filament-breezy::default.profile.2fa.regenerate_codes.notify','filament-breezy::default.profile.2fa.confirmation.success_notification',
'filament-breezy::default.profile.2fa.confirmation.invalid_code','filament-breezy::default.profile.sanctum.title','filament-breezy::default.profile.sanctum.description','filament-breezy::default.profile.sanctum.create.notify','filament-breezy::default.profile.sanctum.create.message',
'filament-breezy::default.profile.sanctum.create.submit.label','filament-breezy::default.profile.sanctum.update.notify','filament-breezy::default.profile.sanctum.copied.label','filament-breezy::default.clipboard.link','filament-breezy::default.clipboard.tooltip',
...
'filament-breezy::default.or','filament-breezy::default.cancel',);
