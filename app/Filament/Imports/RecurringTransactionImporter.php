    ...
    public static function getColumns(): array
    {
        return [
            ...
            ImportColumn::make('frequency')
                ->requiredMapping()
                ->examples(['bi-weekly', 'monthly'])
                ->rules(['required', Rule::enum(BillingFrequency::class)]),
            ImportColumn::make('start_date')
                ->requiredMapping()
                ->helperText('Start date format: Y-m-d H:i:s')
                ->examples(['2023-09-10 14:20:39', '2024-10-12 11:20:00'])
                ->rules(['required', 'date_format:Y-m-d H:i:s']),
            ImportColumn::make('end_date')
                ->helperText('End date format: Y-m-d H:i:s')
                ->examples(['2023-09-10 14:20:39', '2024-10-12 11:20:00'])
                ->rules(['required', 'date_format:Y-m-d H:i:s']),
        ];
    }
